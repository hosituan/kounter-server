...
def startCountSteel(filePath, fileName, showConfidence = False, getBox = False):
    image_path = filePath 
    # load image
    ...
    with graph.as_default():
        boxes, hard_scores, labels, soft_scores = GlobalModel.steelModel.predict_on_batch(np.expand_dims(image, axis=0))
